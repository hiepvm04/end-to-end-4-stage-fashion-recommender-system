...
class Transformer(object):
    ...
    def preprocess(self, inputs):
        ...
        # Enrich inputs with customer age (Ép sang kiểu float)
        inputs["age"] = float(customer_features.age.values[0])
        ...
        # Ép sang kiểu float để chống lỗi JSON Serialize
        inputs["month_sin"] = float(feature_vector["month_sin"])
        inputs["month_cos"] = float(feature_vector["month_cos"])
